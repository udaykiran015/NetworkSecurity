...
import pandas as pd
import numpy as np
from networksecurity.entity.artifact_entity import DataValidationArifact,DataTransfomrationArifact
...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArifact,data_transformation_config:DataTransformationConfig):
        try:
            self.data_validation_artifact:DataValidationArifact=data_validation_artifact
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """KNN imputer object with the parameters specified in the training"""
        logging.info("Entered get_data_trasonfeomed methosd for transformation")
        try:
    ...
    def initiate_data_transformation(self)->DataTransfomrationArifact:
        logging.info("enter the data_tranformation method")
        try:
            logging.info("starting data transforamtion process")
            ...
            preprocessing_obj=preprocessing.fit(input_feature_train_df)
            ...
            ##Prep artifacts
            data_transformation_artifact=DataTransfomrationArifact(
